...
complete -f -c m -n '__fish_m_needs_command' -a music -d 'music command line control'
complete -f -c m -n '__fish_m_using_command music ' -a "status" -d 'show status, current artist and track'
complete -f -c m -n '__fish_m_using_command music ' -a "play" -d 'start playing Music'
complete -f -c m -n '__fish_m_using_command music ' -a "pause" -d 'pause Music'
complete -f -c m -n '__fish_m_using_command music ' -a "next" -d 'go to the next track'
complete -f -c m -n '__fish_m_using_command music ' -a "prev" -d 'go to the previous track'
complete -f -c m -n '__fish_m_using_command music ' -a "mute" -d 'mute volume'
complete -f -c m -n '__fish_m_using_command music ' -a "unmute" -d 'mute volume'
complete -f -c m -n '__fish_m_using_command music ' -a "vol" -d 'increase and decrease volume'
complete -f -c m -n '__fish_m_using_command music ' -a "stop" -d 'stop iTune'
complete -f -c m -n '__fish_m_using_command music ' -a "quit" -d 'quit Music'
complete -f -c m -n '__fish_m_using_command music ' -a "help" -d 'Show help'
